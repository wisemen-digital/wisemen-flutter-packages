  ...
  group('AppStyles', () {
    group('largeTitle', () {
      ...
      test('should be immutable', () {
        ...
        expect(
          ...
          const TextStyle(fontWeight: FontWeight.w600, fontSize: 33, height: 0),
        );
      });
    });
    ...
    group('title', () {
      ...
      test('should be immutable', () {
        ...
        expect(
          AppStyles.title,
          const TextStyle(fontWeight: FontWeight.w400, fontSize: 24, height: 0),
        );
      });
    });
    ...
    group('headline', () {
      ...
      test('should be immutable', () {
        ...
        expect(
          AppStyles.headline,
          const TextStyle(fontWeight: FontWeight.w500, fontSize: 14, height: 0),
        );
      });
    });
    ...
    group('subHeadline', () {
      ...
      test('should be immutable', () {
        ...
        expect(
          ...
          const TextStyle(fontWeight: FontWeight.w400, fontSize: 11, height: 0),
        );
      });
    });
    ...
    group('body', () {
      ...
      test('should be immutable', () {
        ...
        expect(
          AppStyles.body,
          const TextStyle(fontWeight: FontWeight.w400, fontSize: 14, height: 0),
        );
      });
    });
    ...
    group('Style hierarchy and relationships', () {
      ...
      test('subHeadline should be the smallest font size', () {
        expect(
          AppStyles.subHeadline.fontSize!,
      ...
      test('largeTitle should have the heaviest font weight', () {
        expect(AppStyles.largeTitle.fontWeight, FontWeight.w600);
        expect(
          AppStyles.largeTitle.fontWeight!.value,
      ...
      test('headline should have medium font weight', () {
        expect(AppStyles.headline.fontWeight, FontWeight.w500);
        expect(
          AppStyles.headline.fontWeight!.value,
          greaterThan(AppStyles.title.fontWeight!.value),
        );
        expect(
          AppStyles.headline.fontWeight!.value,
    ...
    group('Style customization', () {
      ...
      test('original styles should remain unchanged after copyWith', () {
        ...
        final modifiedTitle = AppStyles.title.copyWith(
          color: Colors.green,
          fontSize: 30,
        );
