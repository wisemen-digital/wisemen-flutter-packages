...
@BuiltValue()
abstract class CreateRoleCommand
    implements Built<CreateRoleCommand, CreateRoleCommandBuilder> {
  ...
  factory CreateRoleCommand([void updates(CreateRoleCommandBuilder b)]) =
      _$CreateRoleCommand;
  ...
  static Serializer<CreateRoleCommand> get serializer =>
      _$CreateRoleCommandSerializer();
}

class _$CreateRoleCommandSerializer
    implements PrimitiveSerializer<CreateRoleCommand> {
  @override
