...
// tests for ContactCreatedDomainEventLog
void main() {
  final instance = ContactCreatedDomainEventLogBuilder();
  // TODO add properties to the builder and call build()

  group(ContactCreatedDomainEventLog, () {
    // String uuid
    ...
    // ContactCreatedEventContent content
