...
// tests for ContactDeletedDomainEventLog
void main() {
  final instance = ContactDeletedDomainEventLogBuilder();
  // TODO add properties to the builder and call build()

  group(ContactDeletedDomainEventLog, () {
    // String uuid
    ...
    // ContactDeletedEventContent content
